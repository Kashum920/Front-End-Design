...
ScrollReveal().reveal('.home-content h2, .price_row, .contact_row', { origin: 'top', delay:500 });
ScrollReveal().reveal('.counter-row', { duration:1500, delay: 2500 });
...
ScrollReveal().reveal('#author .athour_row', { origin:'right', duration:500, delay: 1000 });